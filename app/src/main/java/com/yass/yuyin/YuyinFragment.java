 ...
 */
public class YuyinFragment extends BaseFragment implements View.OnClickListener {

    private static final String TAG = "YuyinFragment";

    EditText et_input;
    Button btn_startspeech;
    Button btn_startspeektext;

    // 用HashMap存储听写结果
    private HashMap<String, String> mIatResults = new LinkedHashMap<String, String>();


    public YuyinFragment() {
    }
    ...
    private void initView(View view) {
        ...
        btn_startspeech = (Button) view.findViewById(R.id.btn_startspeech);
        btn_startspeektext = (Button) view.findViewById(R.id.btn_startspeektext);
    ...
    public String parseVoice(String resultString) {
        ...
        Voice voiceBean = JsonUtil.parseJson(resultString, Voice.class);
    ...
    private void startSpeechDialog() {
        //1. 创建RecognizerDialog对象
        RecognizerDialog mDialog = new RecognizerDialog(_mActivity, new MyInitListener());
        //2. 设置accent、 language等参数
    ...
    class MyRecognizerDialogListener implements RecognizerDialogListener {
        ...
        @Override
        public void onError(SpeechError speechError) {// 启动录音失败.(错误码:20006)
            String sfd = "";// 您好像没有说话哦.(错误码:10118)
