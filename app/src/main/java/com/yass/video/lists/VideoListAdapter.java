...
public class VideoListAdapter extends RecyclerView.Adapter<VideoListAdapter.VideoViewHolder> {
    ...
    public VideoListAdapter.VideoViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_video_play, parent, false);
    ...
    public static class VideoViewHolder extends RecyclerView.ViewHolder {
        ...
        public VideoViewHolder(View itemView) {
            super(itemView);
            mVpvPlayer = itemView.findViewById(R.id.item_video_vpv_player);
            mIvCover = itemView.findViewById(R.id.item_video_iv_cover);
            mTvTitle = itemView.findViewById(R.id.item_video_tv_title);
            mTvPercents = itemView.findViewById(R.id.item_video_tv_percents);
